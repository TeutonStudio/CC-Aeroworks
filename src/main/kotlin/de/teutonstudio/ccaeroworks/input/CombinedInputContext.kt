...
object CombinedInputContext {
     ...
     * ray is scanned in the main level and, when Sable ships intersect it, in each ship's inverse-
     * projected plot space. This keeps the original narrow 3x3x3 corridor without confusing world
     * coordinates with Sable plot coordinates.
     */
    private fun findDeskNearViewRay(minecraft: Minecraft): BlockPos? {
        ...
        for (raySpace in SableSpatial.raySpaces(level, from, to)) {
            visited.clear()
