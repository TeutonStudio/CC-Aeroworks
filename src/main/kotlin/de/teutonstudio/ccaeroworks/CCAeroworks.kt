...
class CCAeroworks(modEventBus: IEventBus, modContainer: ModContainer) {
    ...
    companion object {
        ...
        const val DESK_DISPLAY_INPUT_EVENT: String = "cc_aeroworks_desk_display_input"
        ...
        const val DISPLAY_BINDING_CHANGED_EVENT: String = "cc_aeroworks_display_binding_changed"
