...
import de.teutonstudio.ccaeroworks.radarcompat.display.RadarLinkStatus
...
object CreateRadarCompat {
    ...
    fun refreshDesk(desk: ConsoleBlockEntity) {
        ...
        RadarTrace.event(
            ...
            level,
            desk.blockPos,
            "deskClass=${desk.javaClass.name} hasRadarDisplay=${RadarDeskAccess.hasRadarDisplay(desk)} " +
        ...
        if (!RadarDeskAccess.hasRadarDisplay(desk)) {
